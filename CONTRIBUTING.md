...
- Check the [issue tracker](https://github.com/Abbhiishek/codecommunitymusic-client/issues) for open issues that you can work on or create a new issue if you have a -specific contribution in mind.
...
- Navigate to the project folder and run `yarn install` to install dependencies.
